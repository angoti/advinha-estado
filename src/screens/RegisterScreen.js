...
export default function RegisterScreen() {
	...
	async function handleRegister() {
		...
		try {
			...
			Alert.alert("Erro ao cadastrar", traduzErroFirebase(e));
		} finally {
			setLoading(false);
		}
	}
	...
	function traduzErroFirebase(e) {
		...
		if (msg.includes("auth/email-already-in-use")) return "E-mail já cadastrado.";
		if (msg.includes("auth/invalid-email")) return "E-mail inválido.";
		if (msg.includes("auth/weak-password")) return "Senha fraca (mínimo 6 caracteres).";
